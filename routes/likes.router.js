...
router.get('/:likeID', passport.authenticate('user', { session: false }), likesController.getByID);
router.get('/:product_id', passport.authenticate('user', { session: false }), likesController.getByID);
